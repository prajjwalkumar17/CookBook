...
})({"cec5d9cf4be1c2595334e8e7be35e680":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = 1234;
var HMR_ENV_HASH = "d751713988987e9331980363e24189ce";
module.bundle.HMR_BUNDLE_ID = "532e5d5496cf45c0020ef275fd8d7021";
...
},{}],"8b21e7c1238d41fa18d1e509235ffe27":[function(require,module,exports) {
require('./bundle-manifest').register(JSON.parse("{\"020ef275fd8d7021\":\"controller.532e5d54.js\",\"c3ff58993c9bc9d6\":\"icons.5df0b3c0.svg\"}"));
...
var _PagenationView = _interopRequireDefault(require("./Views/PagenationView.js"));
...
const controlRecipies = async function () {
  try {
    ...
    _recipeView.default.renderSpinner(); //Update resuls view to mark selected search results active
...
const controlSearchResults = async () => {
  try {
    _resultsView.default.renderSpinner(); //Get search qiery from view


    const searchQuery = _searchView.default.getQuery();

    if (!_searchView.default.getQuery) return; //Render results

    await model.loadSearchResults(searchQuery); // resultsView.render(model.state.search.results);

    _resultsView.default.render(model.getSearchResultsPage()); //Render initial pagenation


    _PagenationView.default.render(model.state.search);
  } catch (err) {
    console.log(err);
  }
};
...
const controlPagenation = function (gotoPage) {
  //Render new results
  _resultsView.default.render(model.getSearchResultsPage(gotoPage)); //Render new pagenation bots
...
const controlServings = function (newServings) {
  ...
  _recipeView.default.update(model.state.recipe); //update the recipe view

};

const controlAddBookmark = function () {
  if (!model.state.recipe.bookmarked) model.addBookmark(model.state.recipe);else model.deleteBookmark(model.state.recipe);
...
const init = () => {
  ...
  _recipeView.default.addHandler(controlRecipies);
  ...
  _PagenationView.default.addHandlerClick(controlPagenation);
};

init();
},{"./model.js":"aabf248f40f7693ef84a0cb99f385d1f","./Views/recipeView.js":"e056b7a1cbd1d261b98b22955ac40cc2","core-js/modules/web.immediate.js":"140df4f8e97a45c53c66fead1f5a9e92","./Views/searchView":"3446cc0f02f3b13b04fca581e4a86c89","./Views/resultsView.js":"7f1d505c6e91e33d4d63b3374ea4cf2a","./Views/PagenationView.js":"8676765bc94875a944096f1394d8715a","./Views/bookmarksView.js":"61c2b5c3ebc3652198cd7e82c5e9e932"}],"aabf248f40f7693ef84a0cb99f385d1f":[function(require,module,exports) {
"use strict";
...
const loadRecipe = async function (changedHash) {
  try {
    const realRes = await (0, _helpers.getJson)(`${_config.API_URL}${changedHash}`);
    const {
      recipe
    } = realRes.data;
    state.recipe = {
    ...
    if (state.bookmarks.some(bookmark => bookmark.id === state.recipe.id)) state.recipe.bookmarked = true;else state.recipe.bookmarked = false;
...
const loadSearchResults = async function (searchText) {
  try {
    state.search.query = searchText;
    const datasearch = await (0, _helpers.getJson)(`${_config.API_URL}?search=${searchText}`);
    console.log(datasearch);
    state.search.results = datasearch.data.recipes.map(recipe => {
      return {
        id: recipe.id,
        title: recipe.title,
        publisher: recipe.publisher,
...
const addBookmark = function (recipe) {
  //add bookmark
  state.bookmarks.push(recipe); //mark.curr recipe as bookmark
...
init();
},{"regenerator-runtime":"e155e0d3930b156f86c48e8d05522b16","./config.js":"09212d541c5c40ff2bd93475a904f8de","./helpers":"0e8dcd8a4e1c61cf18f78e1c2563655d"}],"e155e0d3930b156f86c48e8d05522b16":[function(require,module,exports) {
/**
...
exports.TIMEOUT_SECONDS = exports.RESULTS_PER_PAGE = exports.API_URL = void 0;
...
const getJson = async function (Url) {
  try {
    const unFilteredRes = await Promise.race([fetch(Url), timeout(_config.TIMEOUT_SECONDS)]);
    const realRes = await unFilteredRes.json();
    if (!unFilteredRes.ok) throw new Error(`${realRes.message} (${unFilteredRes.status})`);
    return realRes;
  } catch (err) {
    throw err;
  }
...
},{"regenerator-runtime":"e155e0d3930b156f86c48e8d05522b16","./config.js":"09212d541c5c40ff2bd93475a904f8de"}],"e056b7a1cbd1d261b98b22955ac40cc2":[function(require,module,exports) {
"use strict";
  ...
  _generateMarkup() {
    return `
        ...
        <div class="recipe__ingredients">
          ...
          ${this._data.ingredients.map(this._generateMarkup4Ingredients).join('')}
          </div>
...
},{"url:../../img/icons.svg":"99a4485e4c812049c0d1e1617b05916e","./View.js":"c3b8f0c402558f7fe85a8f981ce03ec2"}],"99a4485e4c812049c0d1e1617b05916e":[function(require,module,exports) {
module.exports = require('./bundle-url').getBundleURL() + require('./relative-path')("020ef275fd8d7021", "c3ff58993c9bc9d6");
...
},{"./bundle-manifest":"ba8df6b71e73837c465d69bebde6e64d"}],"c3b8f0c402558f7fe85a8f981ce03ec2":[function(require,module,exports) {
"use strict";
...
class View {
  ...
  update(data) {
    ...
    newElem.forEach((newElem, indx) => {
      ...
      if (!newElem.isEqualNode(curEl) && newElem.firstChild?.nodeValue.trim() !== '') {
...
},{"url:../../img/icons.svg":"99a4485e4c812049c0d1e1617b05916e"}],"140df4f8e97a45c53c66fead1f5a9e92":[function(require,module,exports) {
...
},{"../internals/classof-raw":"901e5a25291bac244011feea921975b2","../internals/global":"7e78823454e7f795898745d93279f917"}],"3446cc0f02f3b13b04fca581e4a86c89":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{}],"7f1d505c6e91e33d4d63b3374ea4cf2a":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"./View.js":"c3b8f0c402558f7fe85a8f981ce03ec2","url:../../img/icons.svg":"99a4485e4c812049c0d1e1617b05916e","./previewView.js":"468b1ddf6f3a2c9cb08390d20839d9e0"}],"468b1ddf6f3a2c9cb08390d20839d9e0":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"url:../../img/icons.svg":"99a4485e4c812049c0d1e1617b05916e","./View.js":"c3b8f0c402558f7fe85a8f981ce03ec2"}],"8676765bc94875a944096f1394d8715a":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"url:../../img/icons.svg":"99a4485e4c812049c0d1e1617b05916e","./View.js":"c3b8f0c402558f7fe85a8f981ce03ec2"}],"61c2b5c3ebc3652198cd7e82c5e9e932":[function(require,module,exports) {
"use strict";
...
class BookmarksView extends _View.default {
  ...
  _generateMarkup() {
    return this._data.map(boookmark => _previewView.default.render(boookmark, false)).join('');
  }
...
exports.default = _default;
},{"url:../../img/icons.svg":"99a4485e4c812049c0d1e1617b05916e","./View.js":"c3b8f0c402558f7fe85a8f981ce03ec2","./previewView.js":"468b1ddf6f3a2c9cb08390d20839d9e0"}]},{},["cec5d9cf4be1c2595334e8e7be35e680","8b21e7c1238d41fa18d1e509235ffe27","175e469a7ea7db1c8c0744d04372621f"], null)

//# sourceMappingURL=controller.532e5d54.js.map
